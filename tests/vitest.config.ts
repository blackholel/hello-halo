...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      '../src/main/services/agent/__tests__/message-flow.guide-live-input.test.ts',
      ...
      '../src/main/services/agent/__tests__/ai-config-resolver.test.ts',
      '../src/main/services/agent/__tests__/provider-resolver.test.ts',
